...
def _validate_layout(
    ...
    Hidden placements are included in validation because
    their runtime visibility still has to be realized.
    """
...
def realize(
    ...
    # ----------------------------------------------------
    # Remove runtime docks that are no longer part of the
    # logical layout.
    #
    # The binding is intentionally retained because the dock
    # remains owned by the panel composition layer and may be
    # included by a later WorkspaceLayout.
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # Realize every placement.
    #
    # Hidden placements must be explicitly realized so a
    # previously visible dock cannot remain visible.
    # ----------------------------------------------------
    ...
    for placement in layout.placements:
        ...
        # CENTER
        #
        # CENTER is the central editor/SLD region, not a
        # Qt dock area.
        # ------------------------------------------------
        ...
        # ------------------------------------------------
        # All non-CENTER placements require a dock.
        # ------------------------------------------------
        ...
        # ------------------------------------------------
        # A hidden placement requires no further visible
        # placement operation.
        # ------------------------------------------------
    ...
    # ----------------------------------------------------
    # Commit only after successful realization.
    # ----------------------------------------------------
...
def clear_realization(
    ...
    represent the association between panel IDs and their
    existing presentation docks, not ownership of the docks.

    A later WorkspaceLayout can therefore be realized again
    without requiring the panel composition layer to recreate
    or re-register every dock.
    """
