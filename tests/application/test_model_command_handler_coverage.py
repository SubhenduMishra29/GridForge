...
MISSING_PIPELINE_COMMANDS = {
    ...
    CREATE_SHUNT: "create_shunt",
    UPDATE_SHUNT: "update_shunt",
    DELETE_SHUNT: "delete_shunt",
    ...
    PUT_SWITCH_IN_SERVICE: "put_switch_in_service",
    TAKE_SWITCH_OUT_OF_SERVICE: "take_switch_out_of_service",
    CREATE_DISCONNECTOR: "create_disconnector",
    UPDATE_DISCONNECTOR: "update_disconnector",
    DELETE_DISCONNECTOR: "delete_disconnector",
    OPEN_DISCONNECTOR: "open_disconnector",
    CLOSE_DISCONNECTOR: "close_disconnector",
    PUT_DISCONNECTOR_IN_SERVICE: "put_disconnector_in_service",
    TAKE_DISCONNECTOR_OUT_OF_SERVICE: "take_disconnector_out_of_service",
    CREATE_FUSE: "create_fuse",
    UPDATE_FUSE: "update_fuse",
    DELETE_FUSE: "delete_fuse",
    BLOW_FUSE: "blow_fuse",
    RESET_FUSE: "reset_fuse",
    PUT_FUSE_IN_SERVICE: "put_fuse_in_service",
    TAKE_FUSE_OUT_OF_SERVICE: "take_fuse_out_of_service",
}
