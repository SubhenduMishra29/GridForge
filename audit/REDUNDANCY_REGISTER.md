...
| Legacy connection subsystem vs active SLD path | Current canonical Application/Core path | Historical audit requires direct consumer tracing before deletion | UI connection code | UNVERIFIED | GF-MASTER-0043 |
