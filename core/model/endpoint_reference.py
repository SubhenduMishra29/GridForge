# ============================================================
# File: core/model/endpoint_reference.py
# GridForge V2 — Core Endpoint Identity
...
Defines the canonical immutable identity contract used across Core,
Application, and UI boundary adapters to identify electrical endpoints.
...
class EndpointReferenceKind(str, Enum):
    """
    Type of electrical endpoint represented by the canonical Core identity contract.
    """
...
class EndpointReference:
    """
    Immutable Core reference to a canonical electrical endpoint.
