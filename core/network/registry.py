...
class NetworkRegistry:
    ...
    @property
    def grids(self) -> tuple[Any, ...]: return self._values(self._grids)
    @property
    def generators(self) -> tuple[Any, ...]: return self._values(self._generators)
    @property
    def synchronous_machines(self) -> tuple[Any, ...]: return self._values(self._synchronous_machines)
    @property
    def loads(self) -> tuple[Any, ...]: return self._values(self._loads)
    @property
    def motors(self) -> tuple[Any, ...]: return self._values(self._motors)
    @property
    def shunts(self) -> tuple[Any, ...]: return self._values(self._shunts)
    @property
    def capacitors(self) -> tuple[Any, ...]: return self._values(self._capacitors)
    @property
    def reactors(self) -> tuple[Any, ...]: return self._values(self._reactors)
    @property
    def solar(self) -> tuple[Any, ...]: return self._values(self._solar)
    @property
    def batteries(self) -> tuple[Any, ...]: return self._values(self._batteries)
    @property
    ...
    @property
    def switches(self) -> tuple[Any, ...]: return self._values(self._switches)
    @property
    def disconnectors(self) -> tuple[Any, ...]: return self._values(self._disconnectors)
    @property
    def fuses(self) -> tuple[Any, ...]: return self._values(self._fuses)
    ...
    def remove_bus(self, element: Any) -> None: self._remove(self._buses, element)
    def add_grid(self, element: Any) -> None: self._add(self._grids, element)
    def remove_grid(self, element: Any) -> None: self._remove(self._grids, element)
    def add_generator(self, element: Any) -> None: self._add(self._generators, element)
    def remove_generator(self, element: Any) -> None: self._remove(self._generators, element)
    def add_synchronous_machine(self, element: Any) -> None: self._add(self._synchronous_machines, element)
    def remove_synchronous_machine(self, element: Any) -> None: self._remove(self._synchronous_machines, element)
    def add_load(self, element: Any) -> None: self._add(self._loads, element)
    def remove_load(self, element: Any) -> None: self._remove(self._loads, element)
    def add_motor(self, element: Any) -> None: self._add(self._motors, element)
    def remove_motor(self, element: Any) -> None: self._remove(self._motors, element)
    def add_shunt(self, element: Any) -> None: self._add(self._shunts, element)
    def remove_shunt(self, element: Any) -> None: self._remove(self._shunts, element)
    def add_capacitor(self, element: Any) -> None: self._add(self._capacitors, element)
    def remove_capacitor(self, element: Any) -> None: self._remove(self._capacitors, element)
    def add_reactor(self, element: Any) -> None: self._add(self._reactors, element)
    def remove_reactor(self, element: Any) -> None: self._remove(self._reactors, element)
    def add_solar(self, element: Any) -> None: self._add(self._solar, element)
    def remove_solar(self, element: Any) -> None: self._remove(self._solar, element)
    def add_battery(self, element: Any) -> None: self._add(self._batteries, element)
    ...
    def remove_cable(self, element: Any) -> None: self._remove(self._cables, element)
    def add_transformer(self, element: Any) -> None: self._add(self._transformers, element)
    def remove_transformer(self, element: Any) -> None: self._remove(self._transformers, element)
    def add_breaker(self, element: Any) -> None: self._add(self._breakers, element)
    def remove_breaker(self, element: Any) -> None: self._remove(self._breakers, element)
    def add_switch(self, element: Any) -> None: self._add(self._switches, element)
    def remove_switch(self, element: Any) -> None: self._remove(self._switches, element)
    def add_disconnector(self, element: Any) -> None: self._add(self._disconnectors, element)
    def remove_disconnector(self, element: Any) -> None: self._remove(self._disconnectors, element)
    def add_fuse(self, element: Any) -> None: self._add(self._fuses, element)
    def remove_fuse(self, element: Any) -> None: self._remove(self._fuses, element)
