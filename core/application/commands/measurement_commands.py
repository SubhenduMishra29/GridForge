...
class UpdateCurrentTransformerCommand(Command):
    def __init__(self, *, transformer_id: str, name: str | None = None, primary_rated_current_a: float | None = None, secondary_rated_current_a: float | None = None, burden_va: float | None = None, accuracy_class: str | None = None, frequency_hz: float | None = None, polarity: str | None = None, in_service: bool | None = None, p1_endpoint: EndpointReference | None = None, p2_endpoint: EndpointReference | None = None, s1_endpoint: EndpointReference | None = None, s2_endpoint: EndpointReference | None = None, command_id: UUID | None = None, correlation_id: UUID | None = None, causation_id: UUID | None = None):
        for value in (p1_endpoint, p2_endpoint, s1_endpoint, s2_endpoint): _endpoint(value)
        _update((name, primary_rated_current_a, secondary_rated_current_a, burden_va, accuracy_class, frequency_hz, polarity, in_service, p1_endpoint, p2_endpoint, s1_endpoint, s2_endpoint), "UpdateCurrentTransformerCommand")
...
class UpdateCapacitiveVoltageTransformerCommand(Command):
    def __init__(self, *, transformer_id: str, name: str | None = None, rated_primary_voltage_kv: float | None = None, rated_secondary_voltage_v: float | None = None, accuracy_class: str | None = None, rated_burden_va: float | None = None, polarity: str | None = None, frequency_hz: float | None = None, in_service: bool | None = None, h1_endpoint: EndpointReference | None = None, h2_endpoint: EndpointReference | None = None, x1_endpoint: EndpointReference | None = None, x2_endpoint: EndpointReference | None = None, command_id: UUID | None = None, correlation_id: UUID | None = None, causation_id: UUID | None = None):
        for value in (h1_endpoint, h2_endpoint, x1_endpoint, x2_endpoint): _endpoint(value)
        _update((name, rated_primary_voltage_kv, rated_secondary_voltage_v, accuracy_class, rated_burden_va, polarity, frequency_hz, in_service, h1_endpoint, h2_endpoint, x1_endpoint, x2_endpoint), "UpdateCapacitiveVoltageTransformerCommand")
