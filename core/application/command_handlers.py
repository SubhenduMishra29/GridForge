...
class ModelCommandHandlers:
    ...
    def create_grid(self, command, context, transaction): return self._model_service.create_grid(transaction=transaction, **self._resolve(dict(command.payload), context, "endpoint"))
    ...
    def create_load(self, command, context, transaction): return self._model_service.create_load(transaction=transaction, **self._resolve(dict(command.payload), context, "endpoint"))
