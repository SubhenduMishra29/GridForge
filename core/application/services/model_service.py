...
class ModelService(ModelServiceSupport):
    ...
    def create_switch(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.create_switch(**kwargs)

    def update_switch(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.update_switch(**kwargs)

    def delete_switch(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.delete_switch(**kwargs)

    def open_switch(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.open_switch(**kwargs)

    def close_switch(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.close_switch(**kwargs)

    def put_switch_in_service(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.put_switch_in_service(**kwargs)

    def take_switch_out_of_service(self, **kwargs) -> ApplicationResult[Switch]:
        return self._switching_service.take_switch_out_of_service(**kwargs)

    def create_disconnector(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.create_disconnector(**kwargs)

    def update_disconnector(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.update_disconnector(**kwargs)

    def delete_disconnector(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.delete_disconnector(**kwargs)

    def open_disconnector(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.open_disconnector(**kwargs)

    def close_disconnector(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.close_disconnector(**kwargs)

    def put_disconnector_in_service(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.put_disconnector_in_service(**kwargs)

    def take_disconnector_out_of_service(self, **kwargs) -> ApplicationResult[Disconnector]:
        return self._switching_service.take_disconnector_out_of_service(**kwargs)

    def create_fuse(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.create_fuse(**kwargs)

    def update_fuse(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.update_fuse(**kwargs)

    def delete_fuse(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.delete_fuse(**kwargs)

    def blow_fuse(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.blow_fuse(**kwargs)

    def reset_fuse(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.reset_fuse(**kwargs)

    def put_fuse_in_service(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.put_fuse_in_service(**kwargs)

    def take_fuse_out_of_service(self, **kwargs) -> ApplicationResult[Fuse]:
        return self._switching_service.take_fuse_out_of_service(**kwargs)
