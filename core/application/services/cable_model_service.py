...
class CableModelService(ModelServiceSupport):
    ...
    def update_cable(
        ...
        *,
        ...
        values = (
            name, length_km, rated_voltage_kv, rated_current_a,
            r1_ohm_per_km, x1_ohm_per_km, b1_us_per_km,
            r0_ohm_per_km, x0_ohm_per_km, b0_us_per_km, in_service,
        )
        ...
        for key, value in (
            ...
            ("r1_ohm_per_km", r1_ohm_per_km), ("x1_ohm_per_km", x1_ohm_per_km),
            ("b1_us_per_km", b1_us_per_km), ("r0_ohm_per_km", r0_ohm_per_km),
            ("x0_ohm_per_km", x0_ohm_per_km), ("b0_us_per_km", b0_us_per_km),
        ):
